# site pour du covoiturage entre collègues
...
# Les outils nécessaires pour développer la plateforme proprement
## Le Front-end: Interface du site
...
## Le Back-end: Gestion des données et du serveur
...
GitHub nous permettra d’héberger le projet en ligne.
...
Figma permet nous permettra dans ce cas d'avoir une simple visualisation du futur site. A quoi il pourrait ressembler, le design, etc...
...
Selon l’évolution du projet, certains outils pourraient être ajoutés plus tard:
